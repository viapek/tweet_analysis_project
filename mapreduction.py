...
map = Code("function map() {"
           "   var littlewords = ['HTTPS', 'HTTP', 'DO', 'BE', 'IS', 'WAS', 'AM', 'ARE', 'WERE', 'HAS', 'HAD', 'HAVE', 'ALL', 'NOT', 'NO', 'YOURS', 'OR', 'SO', 'FOR', 'ME', 'HE', 'HIM', 'HIS', 'IN', 'IF', 'WITH', 'OF', 'WHAT', 'WHO', 'WHY', 'HOW', 'WHEN', 'WHERE', 'AS', 'AN', 'AT', 'THE', 'IT', 'FROM', 'TO', 'BY', 'BUT', 'ONLY', 'YOU', 'YOUR', 'WE', 'WILL', 'WOULD', 'THAT', 'THEY', 'THIS', 'ON', 'MY', 'OUR'];"
           ...
           "     if (littlewords.indexOf(words[i].toUpperCase()) == -1 && words[i].length > 2) {"
